...
const Hero: React.FC = () => {
  return (
    <section id="inicio" className="relative h-screen min-h-[600px] flex items-center justify-center bg-hero-pattern bg-cover bg-center bg-no-repeat bg-fixed overflow-hidden">
      ...
      {/* Dynamic Overlay with stronger contrast */}
      <div className="absolute inset-0 bg-gradient-to-t from-dark-950 via-dark-950/60 to-dark-950/40"></div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <FadeIn delay={100} direction="down">
            {/* NEW BADGE STYLE: Solid Gold */}
            <div className="mb-8 inline-flex items-center gap-2 px-6 py-2 bg-gold-500 text-dark-950 rounded-sm shadow-[0_0_20px_rgba(212,175,55,0.3)] transform hover:scale-105 transition-transform duration-300">
          ...
          <FadeIn delay={300}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-[1.1] mb-8 drop-shadow-2xl">
              Defesa <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 via-gold-500 to-gold-600">Combata</span> <br />
              & Estratégica
            </h1>
          </FadeIn>
          ...
          <FadeIn delay={500}>
            <div className="flex flex-col items-center">
              <div className="h-1 w-24 bg-gold-500 mb-8 rounded-full"></div>
              <p className="text-lg md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed font-light">
                Não deixe sua liberdade nas mãos da sorte. Atuação especializada em <strong className="text-gold-400">Tribunais Superiores</strong> e casos de alta complexidade.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={700} direction="up">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Button 
                variant="outline" 
                href="#atuacao"
                className="w-full sm:w-auto min-w-[240px] py-4 text-base border-2 hover:bg-white/5"
              >
